// -----------------------------------------------------------------------
// <copyright file="EmailFunctionAppDtoMapperProfile.cs" company="Keka Inc">
...
public class EmailFunctionAppDtoMapperProfile : Profile
{
    /// <summary>
    /// Initializes a new instance of the <see cref="EmailFunctionAppDtoMapperProfile"/> class.
    /// </summary>
    public EmailFunctionAppDtoMapperProfile()
    {
