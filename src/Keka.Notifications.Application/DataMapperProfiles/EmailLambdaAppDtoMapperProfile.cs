// -----------------------------------------------------------------------
// <copyright file="EmailLambdaAppDtoMapperProfile.cs" company="Keka Inc">
...
/// <summary>
/// The email lambda app dto mapper profile class.
/// </summary>
/// <seealso cref="Profile"/>
public class EmailLambdaAppDtoMapperProfile : Profile
{
    /// <summary>
    /// Initializes a new instance of the <see cref="EmailLambdaAppDtoMapperProfile"/> class.
    /// </summary>
    public EmailLambdaAppDtoMapperProfile()
    {
