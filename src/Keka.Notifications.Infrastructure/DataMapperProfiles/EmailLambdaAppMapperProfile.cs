// -----------------------------------------------------------------------
// <copyright file="EmailLambdaAppMapperProfile.cs" company="Keka Inc">
...
/// <summary>
/// The email lambda app mapper profile class.
/// </summary>
/// <seealso cref="Profile"/>
public class EmailLambdaAppMapperProfile : Profile
{
    /// <summary>
    /// Initializes a new instance of the <see cref="EmailLambdaAppMapperProfile"/> class.
    /// </summary>
    public EmailLambdaAppMapperProfile()
    {
