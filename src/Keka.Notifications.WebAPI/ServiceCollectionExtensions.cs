...
public static class ServiceCollectionExtensions
{
    ...
    public static IKekaAppBuilder AddHealthChecks(this IKekaAppBuilder builder, IConfiguration configuration)
    {
        ...
        hcBuilder.AddSqlServer(configuration.GetRequiredConnectionString("NotificationsDB"), name: "NotificationsDB-check", tags: SqlTags);

        // Add health check for service bus
        hcBuilder.AddAzureServiceBusTopic(
            configuration.GetRequiredValue("ServiceBus:ConnectionString"),
            configuration.GetRequiredValue("ServiceBus:TopicName"),
            name: "NotificationsServiceBus-check",
            tags: ServiceBusTags);
